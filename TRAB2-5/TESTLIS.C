...
*     1       gac    27/09/2015 alteração e finalização
*
***************************************************************************/
...
static const char PROC_VALOR_CMD          [ ] = "=procuravalor"    ;
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar inserir elemento antes */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_ANTES_CMD ) == 0 )
         {
            ...
            CondRetLis = LIS_InserirElementoAntes( vtListas[ inxLista ] , pDado ) ;
            ...
            return TST_CompararInt( CondRetEsp , CondRetLis ,
      ...
      /* Testar inserir elemento apos */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_APOS_CMD ) == 0 )
         {
            ...
            CondRetLis = LIS_InserirElementoApos( vtListas[ inxLista ] , pDado ) ;
      ...
      /* Testar ir para o elemento inicial */
		 else if (strcmp (ComandoTeste, PROC_VALOR_CMD) == 0)
		 {
			...
			CondRetLis = LIS_ProcurarValor (vtListas[inxLista],StringDado);

			
	      return TST_CompararInt(CondRetEsp,CondRetLis,"Erro ao obter valor");
		 }
